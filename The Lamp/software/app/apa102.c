...
void ICACHE_FLASH_ATTR apa102_set8(uint8_t global, uint8_t blue, uint8_t green, uint8_t red)
{
	led_spi_master_16bit_write(HSPI,global, red);
	led_spi_master_16bit_write(HSPI, green, blue);
